    ...
    namespace tests {
        ...
        protected:
            ...
            void SetUp() override {
                ...
                this->database.renderObjects = {new mvlizer::rendering::tests::MockIRenderObject(),
                                                new mvlizer::rendering::tests::MockIRenderObject(),
                                                new mvlizer::rendering::tests::MockIRenderObject()};
        ...
        TEST_F(DatabaseTests_Update, calls_update_on_render_objects) {
            ...
            for (auto obj: database.renderObjects) {
                EXPECT_CALL(*(rendering::tests::MockIRenderObject*) obj, tick())
                        .Times(NUMS_TO_TRY);
            }
